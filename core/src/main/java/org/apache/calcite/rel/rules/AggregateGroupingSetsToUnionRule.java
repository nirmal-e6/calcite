...
/**
 * E6 Copy - THIS RULE HAS BEEN COPIED HERE AS IT WAS NOT AVAILABLE IN THE CALCITE VERSION WE HAD. REMOVE THIS ONCE WE UPGRADE
 * TO THE VERSION CONTAINING THIS RULE
 *
 * Rule that converts a {@link Aggregate} with
