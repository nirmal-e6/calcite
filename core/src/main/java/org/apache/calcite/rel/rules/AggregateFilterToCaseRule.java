 ...
 *
 * <p>Rule that converts true filtered aggregates into CASE-style filtered aggregates.
 *
 * <p>For example,
 *
 * <blockquote>
...
public class AggregateFilterToCaseRule extends RelRule<AggregateFilterToCaseRule.Config>
  ...
  @Override public void onMatch(RelOptRuleCall call) {
    ...
    for (AggregateCall aggregateCall : aggregate.getAggCallList()) {
      AggregateCall newCall =
          transform(
              aggregateCall, relBuilder.getRexBuilder(), relBuilder.getTypeFactory(), newProjects);
    ...
    relBuilder.push(project.getInput()).project(newProjects, projectNames);
  ...
  private static AggregateCall transform(
      AggregateCall call,
  ...
  public interface Config extends RelRule.Config {
    Config DEFAULT =
        ImmutableAggregateFilterToCaseRule.Config.of()
            .withOperandSupplier(
                b0 ->
