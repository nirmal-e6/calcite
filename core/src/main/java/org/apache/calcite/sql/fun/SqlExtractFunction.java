...
public class SqlExtractFunction extends SqlFunction {
  ...
  private static final SqlSingleOperandTypeChecker INTERVAL_TIMESTAMP =
      OperandTypes.family(SqlTypeFamily.DATETIME_INTERVAL, SqlTypeFamily.TIMESTAMP);

  private static final SqlSingleOperandTypeChecker INTERVAL_TIME =
      OperandTypes.family(SqlTypeFamily.DATETIME_INTERVAL, SqlTypeFamily.TIME);

  private static final SqlSingleOperandTypeChecker OPERAND_TYPE_CHECKER =
      OperandTypes.or(OperandTypes.INTERVAL_SAME_SAME, INTERVAL_TIMESTAMP, INTERVAL_TIME);
  ...
  private static final SqlReturnTypeInference EXTRACT_RETURN_TYPE =
      opBinding ->
          (CalciteForkSettings.nativeExecutor()
