...
/**
 * Enumeration of the type names which can be used to construct a SQL type. Rationale for this class's existence
 * (instead of just using the standard java.sql.Type ordinals):
 *
 * <ul>
...
public enum SqlTypeName
{
    ...
    DECIMAL(PrecScale.NO_NO | PrecScale.YES_NO | PrecScale.YES_YES, false, Types.DECIMAL, SqlTypeFamily.NUMERIC),
    ...
    TIME_WITH_LOCAL_TIME_ZONE(PrecScale.NO_NO | PrecScale.YES_NO, false, Types.TIME, SqlTypeFamily.TIME),
    ...
    TIMESTAMP_WITH_LOCAL_TIME_ZONE(PrecScale.NO_NO | PrecScale.YES_NO, false, Types.TIMESTAMP, SqlTypeFamily.TIMESTAMP),
    TIMESTAMP_TZ(PrecScale.NO_NO | PrecScale.YES_NO, false, Types.TIMESTAMP, SqlTypeFamily.TIMESTAMP),
    ...
    INTERVAL_HOUR(PrecScale.NO_NO | PrecScale.YES_NO | PrecScale.YES_YES, false, Types.OTHER,
        SqlTypeFamily.INTERVAL_DAY_TIME),
    INTERVAL_HOUR_MINUTE(PrecScale.NO_NO | PrecScale.YES_NO | PrecScale.YES_YES, false, Types.OTHER,
        SqlTypeFamily.INTERVAL_DAY_TIME),
    INTERVAL_HOUR_SECOND(PrecScale.NO_NO | PrecScale.YES_NO | PrecScale.YES_YES, false, Types.OTHER,
        SqlTypeFamily.INTERVAL_DAY_TIME),
    INTERVAL_MINUTE(PrecScale.NO_NO | PrecScale.YES_NO | PrecScale.YES_YES, false, Types.OTHER,
        SqlTypeFamily.INTERVAL_DAY_TIME),
    INTERVAL_MINUTE_SECOND(PrecScale.NO_NO | PrecScale.YES_NO | PrecScale.YES_YES, false, Types.OTHER,
        SqlTypeFamily.INTERVAL_DAY_TIME),
    ...
    ANY(PrecScale.NO_NO | PrecScale.YES_NO | PrecScale.YES_YES, true, Types.JAVA_OBJECT, SqlTypeFamily.ANY),
    ...
    DYNAMIC_STAR(PrecScale.NO_NO | PrecScale.YES_NO | PrecScale.YES_YES, true, Types.JAVA_OBJECT, SqlTypeFamily.ANY),
    /**
...
public static final List<SqlTypeName> ALL_TYPES = ImmutableList.of(BOOLEAN, INTEGER, VARCHAR, DATE, TIME, TIMESTAMP,
    NULL, DECIMAL, ANY, CHAR, BINARY, VARBINARY, TINYINT, SMALLINT, BIGINT, REAL, DOUBLE, SYMBOL, INTERVAL_YEAR,
    INTERVAL_YEAR_MONTH, INTERVAL_MONTH, INTERVAL_DAY, INTERVAL_DAY_HOUR, INTERVAL_DAY_MINUTE, INTERVAL_DAY_SECOND,
    INTERVAL_HOUR, INTERVAL_HOUR_MINUTE, INTERVAL_HOUR_SECOND, INTERVAL_MINUTE, INTERVAL_MINUTE_SECOND, INTERVAL_SECOND,
    TIME_WITH_LOCAL_TIME_ZONE, TIME_TZ, TIMESTAMP_WITH_LOCAL_TIME_ZONE, TIMESTAMP_TZ, FLOAT, MULTISET, DISTINCT,
    STRUCTURED, ROW, CURSOR, COLUMN_LIST, VARIANT);
...
public static final List<SqlTypeName> DATETIME_TYPES = ImmutableList.of(DATE, TIME, TIME_WITH_LOCAL_TIME_ZONE, TIME_TZ,
    TIMESTAMP, TIMESTAMP_WITH_LOCAL_TIME_ZONE, TIMESTAMP_TZ);

/**
 * Types that contain time zone information.
 */
public static final List<SqlTypeName> TZ_TYPES = ImmutableList.of(TIME_WITH_LOCAL_TIME_ZONE, TIME_TZ,
 ...
 */
public static final Set<SqlTypeName> TIME_FRAME_TYPES = Sets.immutableEnumSet(
...
/**
 * Returns true if not of a "pure" standard sql type. "Inpure" types include {@link #ANY}, {@link #NULL} and
 * {@link #SYMBOL}
 */
...
/**
 * Returns the SqlTypeName value whose name or {@link #getSpaceName()} matches the given name, or throws
 * {@link IllegalArgumentException}; never returns null.
 */
...
/**
 * Returns the default scale for this type if supported, otherwise -1 if scale is either unsupported or must be
 * specified explicitly.
 *
 * @deprecated Use {@link org.apache.calcite.rel.type.RelDataTypeSystem#getDefaultScale(SqlTypeName)} but return
 *     Integer.MIN_VALUE if scale is unsupported.
 */
@Deprecated
 ...
 *
 * @deprecated Use {@link org.apache.calcite.rel.type.RelDataTypeSystem#getMinPrecision(SqlTypeName)}.
 */
@Deprecated
 ...
 * scale are not applicable for this type.
 *
 * @return Minimum allowed scale
 *
 * @deprecated Use {@link org.apache.calcite.rel.type.RelDataTypeSystem#getMinScale(SqlTypeName)} but return
 *     Integer.MIN_VALUE if scale is unsupported.
 */
@Deprecated
    ...
    switch (this)
    {
        ...
        case TIME:
            return SqlLiteral.createTime(
                ...
                pos);
        case TIMESTAMP:
            return SqlLiteral.createTimestamp(this,
...
/**
 * Returns the name of this type, with underscores converted to spaces, for example "TIMESTAMP WITH LOCAL TIME ZONE",
 * "DATE".
 */
