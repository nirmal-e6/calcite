...
public class E6TypeSystemImpl extends RelDataTypeSystemImpl {
  ...
  @Override public @Nullable RelDataType deriveDecimalDivideType(
      RelDataTypeFactory typeFactory, RelDataType operand1, RelDataType operand2) {
    if (isDecimal128Enabled()
        && SqlTypeUtil.isExactNumeric(operand1)
  ...
  private RelDataType adjustPrecisionScale(
      RelDataTypeFactory typeFactory, int precision, int scale) {
  ...
  @Override public @Nullable RelDataType deriveDecimalMultiplyType(
