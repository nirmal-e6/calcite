...
/**
 * Extended to change functionality of leastRestrictive method and create sql type with our expected
 * scale changes are in line no. 361, 435, 466
 */
public class E6SqlTypeFactoryImpl extends SqlTypeFactoryImpl {
  ...
  /**
   * Override to limit scale to 6 if scale is 9 then exception is coming in regression
   * query-1628-count_validate_6.txt scale is going out of range
   */
