...
/**
 * Default implementation of {@link RexVisitor}, which visits each node but does nothing while it's
 * there.
 *
...
public class RexVisitorImpl<@Nullable R> implements RexVisitor<R> {
   ...
   *
   * <p>If any of them returns false, returns false immediately; if they all return true, returns
   * true.
   *
   * @see #visitArrayOr
   ...
   *
   * <p>If any of them returns true, returns true immediately; if they all return false, returns
   * false.
   *
   * @see #visitArrayAnd
   * @see RexShuttle#visitArray
