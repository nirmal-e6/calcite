...
/**
 * Internal method to create a call to a literal. Code outside this package should call one of the type-specific methods
 * such as {@link #makeDateLiteral(DateString)}, {@link #makeLiteral(boolean)}, {@link #makeLiteral(String)}.
 *
    ...
    switch (typeName)
    {
        case CHAR:
            ...
            if (nlsString.getCollation() == null || nlsString.getCharset() == null || !Objects.equals(
                nlsString.getCharset(), type.getCharset()) || !Objects.equals(nlsString.getCollation(),
                type.getCollation()))
            {
                assert type.getSqlTypeName() == SqlTypeName.CHAR || type.getSqlTypeName() == SqlTypeName.VARCHAR;
...
//                }
    ...
    {
        throw new IllegalArgumentException("Cannot convert " + o + " to " + type + " due to overflow");
    }
