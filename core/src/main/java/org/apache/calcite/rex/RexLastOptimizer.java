 ...
 * All rights reserved.
 *
 * File Name: RexLastOptimizer.java
 *
 ...
 * <p>
 * Converts LAST(*.$n, offset) patterns:
 * <ul>
 * <li>LAST(*.$n, 0) -> RexInputRef(n) for direct field access</li>
 * <li>LAST(*.$n, offset) where offset > 0 -> LAG(RexInputRef(n), offset) for PREV functionality</li>
 * </ul>
 * <p>
 * This optimization is critical for MATCH_RECOGNIZE to work with ExpressionNode
 * infrastructure which doesn't support LAST function calls directly.
 * <p>
 * Based on VectorSearchProjectBreakdownRule.replaceVectorSearchFunctionWithRexInputRef pattern.
 */
public class RexLastOptimizer extends RexShuttle
{
     ...
     * <p>
     * Matches patterns: LAST(*.$n, 0) and LAST(*.$n, offset) where offset >= 0
     *
     ...
     * </ul>
     * <p>
     * This follows the same pattern as VectorSearchProjectBreakdownRule.replaceVectorSearchFunctionWithRexInputRef.
     *
