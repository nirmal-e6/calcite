...
public interface RexVisitor<R> {
  ...
  R visitNodeAndFieldIndex(RexNodeAndFieldIndex rexNodeAndFieldIndex);
  ...
  /**
   * Visits a list and returns a list of the results. The resulting list is immutable and does not
   * contain nulls.
   */
