...
import org.apache.calcite.rex.E6RexSimplify;
...
public class E6RelBuilder extends RelBuilder {
  ...
  protected E6RelBuilder(
    ...
    this.simplifier = new E6RexSimplify(cluster.getRexBuilder(), predicates, executor);
  }
  ...
  public static RelBuilder create(FrameworkConfig config) {
    return Frameworks.withPrepare(
        ...
        (cluster, relOptSchema, rootSchema, statement) ->
            new E6RelBuilder(config.getContext(), cluster, relOptSchema));
  }
  ...
  public RelBuilder transform(UnaryOperator<Config> transform) {
    ...
    return new E6RelBuilder(context, cluster, relOptSchema);
  }
  ...
  public static RelBuilderFactory proto(final Context context) {
    return (cluster, schema) -> new E6RelBuilder(context, cluster, schema);
  }
  ...
  private RelBuilder aggregate_(GroupKeyImpl groupKey, final ImmutableList<AggCallPlus> aggCalls) {
    ...
    if (groupKey.nodeLists != null) {
      ...
      if (aggCalls.stream().anyMatch(E6RelBuilder::isGroupId)
  ...
  private RelBuilder rewriteAggregateWithDuplicateGroupSets(
    ...
    aggregateCallsWithoutGroupId.removeIf(E6RelBuilder::isGroupId);
   ...
   * RelBuilder b;
   * b.scan("EMP");
   * final GroupKey groupKey = b.groupKey("MGR");
